...
<Navbar />
      ...
      <section className="relative pt-28 pb-20 md:pt-36 md:pb-32 overflow-hidden">
        ...
        <div className="absolute -bottom-20 -left-20 w-72 h-72 rounded-full bg-brand-red/[0.08]"></div>
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12">
          ...
          <div className="max-w-3xl mt-12 md:mt-16">
            ...
            <div className="w-16 h-0.5 bg-white/60 mb-6 animate-hero-fade-up animation-delay-150"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 animate-hero-fade-up animation-delay-300">
              ...
              <a href="tel:+34604910611" className="backdrop-blur-sm border border-white/25 text-white font-display font-medium py-4 px-8 rounded-lg hover:bg-white/10 transition-all duration-300 text-center">
