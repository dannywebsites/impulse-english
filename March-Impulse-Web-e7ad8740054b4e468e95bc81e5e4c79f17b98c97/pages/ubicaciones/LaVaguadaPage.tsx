...
const galleryImages = [
  { url: "/images/academy/locations/outside-academy.jpg", alt: "Fachada exterior Impulse English Academy La Vaguada Barrio del Pilar Madrid" },
  { url: "/images/academy/facilities/classroom-facilities-main-classroom.jpg", alt: "Aula principal academia inglés La Vaguada Barrio del Pilar Madrid" },
  { url: "/images/academy/facilities/technology-based-classroom-photo.jpg", alt: "Aula tecnológica academia inglés La Vaguada Barrio del Pilar Madrid" },
  { url: "/images/academy/facilities/stairs.jpg", alt: "Interior academia dos plantas La Vaguada Barrio del Pilar Madrid" },
  { url: "/images/academy/facilities/infantil-classes.jpg", alt: "Clases inglés infantil La Vaguada Barrio del Pilar Madrid" },
  { url: "/images/academy/facilities/primary-classes-students-smiling.jpg", alt: "Estudiantes primaria felices La Vaguada Barrio del Pilar Madrid" },
  { url: "/images/academy/team/daniel-helping-secondary-school-students.jpg", alt: "Profesor Daniel ayudando estudiantes La Vaguada Barrio del Pilar Madrid" },
  { url: "/images/academy/facilities/secondary-classes-student-happy.jpg", alt: "Estudiante secundaria feliz La Vaguada Barrio del Pilar Madrid" },
  { url: "/images/academy/facilities/adult-one-to-one-classes.jpg", alt: "Clases particulares adultos La Vaguada Barrio del Pilar Madrid" },
  { url: "/images/academy/team/jp-with-students.jpg", alt: "Estudiantes certificados Cambridge La Vaguada Barrio del Pilar Madrid" },
  { url: "/images/academy/facilities/photos-of-facilities.jpg", alt: "Instalaciones academia inglés La Vaguada Barrio del Pilar Madrid" },
  { url: "/images/academy/logos/cambridge-logo-edited.png", alt: "Centro Preparador Cambridge La Vaguada Barrio del Pilar Madrid" },
  { url: "/images/academy/facilities/classroom-facilities-main-classroom.jpg", alt: "Equipo de profesores nativos Impulse English Academy Madrid" },
  { url: "/images/academy/facilities/primary-classes-students-smiling.jpg", alt: "Alumnos aprendiendo inglés en academia de inglés Madrid" },
  { url: "/images/academy/facilities/adult-one-to-one-classes.jpg", alt: "Clase de inglés de adultos en La Vaguada Madrid" },
  { url: "/images/academy/facilities/infantil-classes.jpg", alt: "Clase de inglés infantil en La Vaguada Madrid" },
  { url: "/images/academy/facilities/secondary-classes-student-happy.jpg", alt: "Estudiante en clase de inglés en La Vaguada Madrid" },
  { url: "/images/academy/facilities/stairs.jpg", alt: "Instalaciones interiores Impulse English Academy La Vaguada" },
  { url: "/images/academy/locations/outside-academy.jpg", alt: "Academia inglés La Vaguada Barrio del Pilar exterior" },
  { url: "/images/academy/facilities/technology-based-classroom-photo.jpg", alt: "Aula moderna con tecnología Impulse English La Vaguada" },
  { url: "/images/academy/team/daniel-helping-secondary-school-students.jpg", alt: "Profesor nativo Daniel enseñando en La Vaguada" },
  { url: "/images/academy/team/jp-with-students.jpg", alt: "Alumnos con profesor certificado Cambridge en La Vaguada" },
  { url: "/images/academy/logos/cambridge-logo-edited.png", alt: "Centro Cambridge ES278 Impulse English La Vaguada" },
  { url: "/images/academy/facilities/photos-of-facilities.jpg", alt: "Facilidades academia inglés La Vaguada Barrio del Pilar" }
];
...
<Navbar />
      ...
      <section className="relative pt-28 pb-20 md:pt-36 md:pb-32 overflow-hidden">
        <div className="absolute inset-0">
          <img src="/images/academy/locations/outside-academy.jpg" alt="Academia de inglés Impulse English La Vaguada Barrio del Pilar Madrid" title="Academia de inglés Impulse English La Vaguada Barrio del Pilar Madrid" className="w-full h-full object-cover" loading="eager" />
