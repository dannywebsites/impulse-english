...
const galleryImages = [
  ...
  { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Classroom+Facilities+Main+Classroom.JPG", alt: "Equipo de profesores nativos Impulse English Academy Madrid" },
  { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Primary+classes+students+smiling.JPG", alt: "Alumnos aprendiendo inglés en academia de inglés Madrid" },
  { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Adult+one-to-one+classes.JPG", alt: "Clase de inglés de adultos en La Vaguada Madrid" },
  { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Infantil+classes.JPG", alt: "Clase de inglés infantil en La Vaguada Madrid" },
  { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Secondary+classes+student+happy.JPG", alt: "Estudiante en clase de inglés en La Vaguada Madrid" },
  { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Stairs.JPG", alt: "Instalaciones interiores Impulse English Academy La Vaguada" },
  { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/OUTSIDE+ACADEMY.jpg", alt: "Academia inglés La Vaguada Barrio del Pilar exterior" },
  { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Technology-based+classroom+photo.JPG", alt: "Aula moderna con tecnología Impulse English La Vaguada" },
  { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Daniel+helping+secondary+school+students.JPG", alt: "Profesor nativo Daniel enseñando en La Vaguada" },
  { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/JP+WITH+STUDENTS.jpg", alt: "Alumnos con profesor certificado Cambridge en La Vaguada" },
  { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/NEW/Cambridge+logo+-+Edited.png", alt: "Centro Cambridge ES278 Impulse English La Vaguada" },
  { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Photos+of+facilities.JPG", alt: "Facilidades academia inglés La Vaguada Barrio del Pilar" }
];
...
<Navbar />
      ...
      <section className="relative pt-28 pb-20 md:pt-36 md:pb-32 overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/OUTSIDE+ACADEMY.jpg" alt="Academia de inglés Impulse English La Vaguada Barrio del Pilar Madrid" title="Academia de inglés Impulse English La Vaguada Barrio del Pilar Madrid" className="w-full h-full object-cover" loading="eager" />
