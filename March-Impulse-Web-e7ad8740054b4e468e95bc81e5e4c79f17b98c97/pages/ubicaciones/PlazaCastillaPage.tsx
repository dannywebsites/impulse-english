...
const benefits = [
  ...
  { title: "Profesionales de Plaza Castilla Confían en Nosotros", desc: "Más de 150 reseñas de 5 estrellas en Google." },
      ...
      <section className="py-12 md:py-16 px-6 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-zinc-600 mt-4 leading-relaxed">
            Muy cerca de las emblemáticas <strong>Torres KIO (Puerta de Europa)</strong> y del <strong>intercambiador de Plaza Castilla</strong>, nuestra academia se encuentra a solo minutos por la Línea 9. Profesionales del <strong>Canal de Isabel II</strong>, la <strong>Cuatro Torres Business Area</strong> y oficinas del <strong>Paseo de la Castellana</strong> nos eligen por nuestra flexibilidad horaria y resultados. Estamos en el código postal <strong>28029 Madrid</strong>.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-accent-blue">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <div className="flex flex-wrap justify-center gap-3 mb-8">
            ...
            <Link to="/examenes-cambridge/c1-advanced" className="px-4 py-2 rounded-full text-sm font-medium bg-white text-accent-blue hover:bg-yellow-400 hover:text-blue-900 transition-colors">C1 Advanced</Link>
      ...
      <section className="py-16 px-6 bg-zinc-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {[
              { name: "Ana Belén P.", text: "Fantástica academia. Mi hija empezó sin saber nada y en un año ya tiene un nivel increíble. Los profesores son excepcionales." },
              { name: "Roberto Sánchez", text: "Preparé el C1 Advanced aquí y aprobé a la primera. La metodología es muy buena y los profesores te motivan mucho." },
              { name: "Patricia López", text: "Muy recomendable. Ambiente familiar, grupos reducidos y resultados reales. Mis dos hijos van encantados." }
            ].map((testimonial, idx) => (
          ...
          <div className="text-center">
            <p className="text-zinc-600 mb-6">
              Más de 150 familias de Plaza Castilla confían en nosotros. Lee sus experiencias reales en Google.
            </p>
            <a
              href={NAP.gbpUrl}
              target="_blank"
      ...
      <section className="py-16 md:py-20 px-6 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/OUTSIDE+ACADEMY.jpg", alt: "Fachada exterior Impulse English Academy cerca Plaza Castilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Classroom+Facilities+Main+Classroom.JPG", alt: "Aula principal academia inglés cerca Plaza Castilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Technology-based+classroom+photo.JPG", alt: "Aula tecnológica academia inglés cerca Plaza Castilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Stairs.JPG", alt: "Interior academia dos plantas cerca Plaza Castilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Infantil+classes.JPG", alt: "Clases inglés infantil cerca Plaza Castilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Primary+classes+students+smiling.JPG", alt: "Estudiantes primaria felices cerca Plaza Castilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Daniel+helping+secondary+school+students.JPG", alt: "Profesor Daniel ayudando estudiantes cerca Plaza Castilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Secondary+classes+student+happy.JPG", alt: "Estudiante secundaria feliz cerca Plaza Castilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Adult+one-to-one+classes.JPG", alt: "Clases particulares adultos cerca Plaza Castilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/JP+WITH+STUDENTS.jpg", alt: "Estudiantes certificados Cambridge cerca Plaza Castilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Photos+of+facilities.JPG", alt: "Instalaciones academia inglés cerca Plaza Castilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/NEW/Cambridge+logo+-+Edited.png", alt: "Centro Preparador Cambridge cerca Plaza Castilla La Vaguada Madrid" }
            ].map((img, idx) => (
