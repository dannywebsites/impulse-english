      ...
      <section className="py-12 md:py-16 px-6 bg-white">
        <div className="container mx-auto max-w-4xl">
          ...
          <p className="text-zinc-600 mt-4 leading-relaxed">
            Desde el <strong>Parque de La Ventilla</strong> y el <strong>Mercado de La Ventilla</strong>, nuestra academia está a un corto paseo siguiendo el <strong>Paseo de la Castellana</strong> hacia el norte. También puedes llegar fácilmente desde la <strong>estación de Cercanías Fuencarral</strong>. Nos encontramos en el código postal <strong>28029 Madrid</strong>, en pleno corazón de la zona norte.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-zinc-50">
        <div className="container mx-auto max-w-4xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            {[
              { name: "Sandra Moreno", text: "Increíble academia. Mis hijos llevan un año y el avance es impresionante. Profesores nativos muy dedicados." },
              { name: "Fernando Torres", text: "Empecé de cero y en menos de un año ya puedo mantener conversaciones en inglés. Muy contento con Impulse." },
              { name: "Cristina R.", text: "La relación calidad-precio es inmejorable. Grupos pequeños, material incluido y resultados garantizados." }
            ].map((testimonial, idx) => (
          ...
          <div className="text-center">
            <p className="text-zinc-600 mb-6">
              Más de 150 familias de La Ventilla confían en nosotros. Lee sus experiencias reales en Google.
            </p>
            <a
              href={NAP.gbpUrl}
              target="_blank"
      ...
      <section className="py-16 md:py-20 px-6 bg-white">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/OUTSIDE+ACADEMY.jpg", alt: "Fachada exterior Impulse English Academy cerca La Ventilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Classroom+Facilities+Main+Classroom.JPG", alt: "Aula principal academia inglés cerca La Ventilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Technology-based+classroom+photo.JPG", alt: "Aula tecnológica academia inglés cerca La Ventilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Stairs.JPG", alt: "Interior academia dos plantas cerca La Ventilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Infantil+classes.JPG", alt: "Clases inglés infantil cerca La Ventilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Primary+classes+students+smiling.JPG", alt: "Estudiantes primaria felices cerca La Ventilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Daniel+helping+secondary+school+students.JPG", alt: "Profesor Daniel ayudando estudiantes cerca La Ventilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Secondary+classes+student+happy.JPG", alt: "Estudiante secundaria feliz cerca La Ventilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Adult+one-to-one+classes.JPG", alt: "Clases particulares adultos cerca La Ventilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/JP+WITH+STUDENTS.jpg", alt: "Estudiantes certificados Cambridge cerca La Ventilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Photos+of+facilities.JPG", alt: "Instalaciones academia inglés cerca La Ventilla La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/NEW/Cambridge+logo+-+Edited.png", alt: "Centro Preparador Cambridge cerca La Ventilla La Vaguada Madrid" }
            ].map((img, idx) => (
