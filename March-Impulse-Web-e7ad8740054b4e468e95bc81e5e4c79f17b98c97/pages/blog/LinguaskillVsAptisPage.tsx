...
export const articleSchema = generateArticleSchema({
    headline: "Linguaskill vs Aptis: ¿Cuál Elegir? Comparativa Completa 2026",
...
export const faqs: FAQItem[] = [
  ...
  ,
    ...
    {
      question: "¿Cuánto cuestan Linguaskill y Aptis en 2026?",
        ...
        <main className="flex-grow">
          ...
          <header className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
            <div className="absolute inset-0">
              <img src="/images/academy/technology-based-classroom-photo.jpg" alt="Aula tecnológica preparación Linguaskill Impulse English Academy" className="w-full h-full object-cover" loading="eager" />
            ...
            <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <div className="mt-12 md:mt-16">
                ...
                <h1 className="font-serif text-3xl md:text-5xl lg:text-6xl text-white tracking-tight leading-[1.1] mb-6 animate-hero-fade-up animation-delay-100">
                  Linguaskill vs Aptis: ¿Cuál Elegir? Comparativa Completa 2026
                </h1>
