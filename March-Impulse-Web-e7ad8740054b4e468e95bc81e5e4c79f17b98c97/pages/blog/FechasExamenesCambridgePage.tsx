...
export const faqItems = [
  {
    ...
    answer: 'Cambridge Assessment English publica el calendario oficial global entre octubre y noviembre de 2026 en formato PDF descargable desde su web oficial. Este documento incluye todas las convocatorias por nivel y formato (digital/papel) para el año completo 2027. Sin embargo, cada centro autorizado decide qué fechas específicas ofrecerá según su capacidad operativa y demanda local, publicando su calendario particular entre noviembre 2026 y enero 2027. Los candidatos deben consultar tanto el calendario oficial general como el calendario específico de su centro preferido para confirmar disponibilidad real. Las fechas pueden sufrir modificaciones excepcionales por circunstancias extraordinarias, pero históricamente Cambridge mantiene más del 98% de estabilidad en convocatorias planificadas.'
  },
  {
