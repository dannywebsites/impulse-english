        ...
        <main className="flex-grow">
          ...
          <header className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
            <div className="absolute inset-0">
              <img src={blogImages.technologyClassroom.url} alt="Linguaskill reconocimiento internacional validez global Cambridge" className="w-full h-full object-cover" loading="eager" />
