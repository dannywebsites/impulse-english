          ...
          <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <section id="opciones" className="mb-12">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Las academias privadas ofrecen mayor flexibilidad y atención personalizada. En Madrid hay cientos de opciones, desde grandes franquicias hasta academias locales especializadas. Suelen ofrecer grupos reducidos de 6-12 alumnos, horarios flexibles incluyendo tardes-noches y fines de semana, y metodologías comunicativas modernas. Muchas son centros preparadores oficiales para <Link to="/examenes-cambridge" className="text-slate-600 hover:underline">exámenes Cambridge</Link> y <Link to="/linguaskill" className="text-slate-600 hover:underline">Linguaskill</Link>.
                  </p>
                  <div className="flex flex-wrap gap-2">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-6">
                  ...
                  <Link to="/cursos-ingles/adultos" className="inline-flex items-center gap-2 text-blue-700 font-semibold hover:text-blue-800">
            ...
            <section className="mt-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Link to="/examenes-cambridge" className="group bg-gray-50 rounded-xl p-6 hover:bg-slate-50 transition-colors">
                  <h3 className="font-semibold text-gray-900 group-hover:text-slate-700 transition-colors mb-2">
