        ...
        <main className="flex-grow">
          ...
          <header className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
            <div className="absolute inset-0">
              <img src="/images/academy/facilities/infantil-classes.jpg" alt="Niños bilingües aprendiendo inglés sin confusión en clase" className="w-full h-full object-cover" loading="eager" />
