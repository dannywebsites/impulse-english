        ...
        <main className="flex-grow">
          ...
          <header className="relative pt-28 pb-16 md:pt-36 md:pb-24 overflow-hidden">
            <div className="absolute inset-0">
              <img src={blogImages.cambridgeCertificate.url} alt="Estudiante preparándose para el mercado laboral con inglés B1" className="w-full h-full object-cover" loading="eager" />
