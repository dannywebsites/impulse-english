...
export const courseSchema = generateCourseSchema({
  ...
  description: "Clases de inglés para secundaria en La Vaguada / Barrio del Pilar. Preparación EBAU y Cambridge B1, B2, C1 con grupos reducidos y seguimiento. 100% de aprobados en B2 First en 2024/25 y 2025/26 (alumnos presentados).",
...
export const faqs: FAQItem[] = [
  {
    ...
    answer: "Av. de El Ferrol, 22, junto al centro comercial La Vaguada. Metro Barrio del Pilar (Línea 9) está a 4 minutos andando, así que vienen solos sin problema."
  },
  {
    question: "¿Cuánto se tarda desde los institutos del barrio?",
    answer: "Desde los institutos de Barrio del Pilar y La Vaguada se viene andando, que es lo que permite encajar las clases justo después del instituto."
  },
  {
      ...
      <section className="section-lead px-6 bg-indigo-600">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-white/90 font-medium">
            100% de aprobados en B2 First en 2024/25 y 2025/26 (alumnos presentados)
          </p>
        </div>
      </section>
