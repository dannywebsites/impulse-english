...
export const faqs: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Somos Centro Oficial de Preparación Cambridge. Preparamos todos los niveles: Pre-A1 Starters, A1 Movers, A2 Flyers, A2 Key, B1 Preliminary, B2 First, C1 Advanced y C2 Proficiency. También ofrecemos preparación para Linguaskill, con certificado en 48 horas. En los cursos 2024/25 y 2025/26 aprobaron el B2 First todos los alumnos que presentamos (100% de aprobados, alumnos presentados)."
  },
  {
...
export default function CursosOverviewPage() {
  ...
  return (
    <>
        ...
        <div className="relative z-10 container mx-auto px-6 md:px-12">
          ...
          <div className="max-w-4xl mt-12 md:mt-16">
            ...
            <div className="flex flex-wrap gap-3 mb-8 animate-hero-fade-up animation-delay-300">
              ...
              <span className="border border-white/15 px-4 py-2 rounded-full text-white/80 font-display text-sm">100% aprobados B2 First 24/25 y 25/26</span>
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-8 bg-white rounded-xl border border-zinc-100">
              ...
              <h3 className="font-bold text-zinc-900 text-lg mb-3">100% de aprobados en B2 First en 24/25 y 25/26 (alumnos presentados)</h3>
              <p className="text-zinc-600 text-sm">
      ...
      <TeacherCard
        heading="Quién está detrás de los cursos"
        imageAlt="JP, director de estudios y cofundador de Impulse English Academy en La Vaguada"
      >
            <p>Detrás de todos los cursos están JP, director de estudios y cofundador, con más de 10 años enseñando inglés y experto en exámenes Cambridge, y Danny, cofundador, irlandés afincado en Madrid desde hace 12 años.</p>
      </TeacherCard>
      ...
      <CTABand
        title="¿No sabes qué curso te encaja?"
        subtitle="Hacemos una prueba de nivel gratuita de 25 minutos y te decimos en qué grupo entrarías."
        whatsappText="Hola, me gustaría saber qué curso me encaja"
      />

      <PriceLocationCards heading="Precios de los cursos">
        <p>Infantil desde <strong>64 €/mes</strong> · Primaria <strong>83 €/mes</strong> · Secundaria desde <strong>87 €/mes</strong> · Adultos <strong>94 €/mes</strong> · Clases particulares <strong>29 €/hora</strong>.</p>
        <p>A la cuota mensual se añaden la matrícula (<strong>45 €</strong>, una sola vez) y el libro de texto (<strong>máximo 40 €</strong>). Las tasas de los exámenes oficiales Cambridge y Linguaskill van aparte. Hay descuento por pago trimestral y descuento familiar.</p>
      </PriceLocationCards>

      <GoogleReviews
        heading="Lo que dicen las familias y los alumnos"
      ...
      <CTABand
        title="Matrícula abierta para el curso 2026/27"
        subtitle="Grupos de infantil a adultos en La Vaguada, con descuento por pago trimestral y descuento familiar."
        whatsappText="Hola, me gustaría información sobre la matrícula"
      />
