...
export default function GraciasPage({ heroImageSrc }: GraciasPageProps) {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
    ...
    <>
      ...
      <section className="relative pt-28 pb-20 md:pt-36 md:pb-32 overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImageSrc || '/images/academy/team/jp-with-students.jpg'} alt="Estudiantes con profesor Impulse English Academy" className="w-full h-full object-cover" loading="eager" fetchPriority="high" />
