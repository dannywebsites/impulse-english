  ...
  const courses = [
    {
      ...
      link: "/ingles-la-vaguada/infantil"
    },
    {
      ...
      link: "/ingles-la-vaguada/primaria"
    },
    {
      ...
      image: "/images/academy/facilities/escuela-gonzalo-18.jpeg",
      link: "/ingles-la-vaguada/secundaria"
    },
    {
      category: "A2",
    ...
    <section id="courses" className="w-full bg-white py-12 px-6 border-t border-zinc-100">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-8">
            ...
            <Link to="/ingles-la-vaguada/particulares" className="text-zinc-500 hover:text-accent-blue font-medium flex items-center gap-2 transition-colors">
