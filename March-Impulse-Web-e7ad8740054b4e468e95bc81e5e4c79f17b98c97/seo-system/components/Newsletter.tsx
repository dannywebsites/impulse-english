      ...
      <div className="container mx-auto max-w-7xl bg-white rounded-lg p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-8 border border-zinc-100 shadow-sm">
        ...
        <div className="flex flex-col gap-8 w-full md:w-auto items-center md:items-start">
            ...
            <div className="flex items-center gap-6 justify-center md:justify-start text-zinc-400">
                <a href="https://www.instagram.com/impulse_english_academy/" target="_blank" rel="noopener noreferrer" className="hover:text-accent-blue transition-colors" aria-label="Instagram"><Instagram size={20} /></a>
                <a href="https://www.facebook.com/impulseenglish.es" target="_blank" rel="noopener noreferrer" className="hover:text-accent-blue transition-colors" aria-label="Facebook"><Facebook size={20} /></a>
                <a href="https://www.tiktok.com/@impulse_english" target="_blank" rel="noopener noreferrer" className="hover:text-accent-blue transition-colors" aria-label="TikTok"><TikTokIcon /></a>
                <a href="https://x.com/impulse_vaguada" target="_blank" rel="noopener noreferrer" className="hover:text-accent-blue transition-colors" aria-label="X"><XIcon /></a>
                <a href="https://www.linkedin.com/company/101859096/" target="_blank" rel="noopener noreferrer" className="hover:text-accent-blue transition-colors" aria-label="LinkedIn"><Linkedin size={20} /></a>
                <a href="https://www.youtube.com/@Impulse-English" target="_blank" rel="noopener noreferrer" className="hover:text-accent-blue transition-colors" aria-label="YouTube"><Youtube size={20} /></a>
            </div>
        </div>
