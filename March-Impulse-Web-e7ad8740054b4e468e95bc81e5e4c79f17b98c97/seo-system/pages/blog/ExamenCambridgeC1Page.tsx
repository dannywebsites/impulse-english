...
const c1AdvancedFaqs = [
  ...
  {
    question: "¿Qué diferencia hay entre B2 y C1?",
    answer: "La diferencia entre B2 y C1 radica en el nivel de competencia: B2 (puntuación 160-179 Cambridge) permite comprender textos complejos, mantener conversaciones sobre temas variados y redactar textos detallados expresando opiniones. C1 (puntuación 180-199) implica dominio avanzado para participar eficazmente en reuniones especializadas, leer a velocidad académica, manejar temas abstractos con gran fluidez, negociaciones complejas y redactar trabajos coherentes para estudios de grado y posgrado."
  }
];
...
const faqs = [
  {
    question: '¿Cuánto tiempo dura el examen Cambridge C1 Advanced?',
    answer: 'El examen C1 Advanced dura aproximadamente 4 horas en total: Reading and Use of English (90 minutos), Writing (90 minutos), Listening (40 minutos) y Speaking (15 minutos). El Speaking se realiza generalmente en un día diferente, en parejas con otro candidato.'
  },
  {
    question: '¿Qué puntuación necesito para aprobar el C1 Advanced?',
    answer: 'Necesitas obtener al menos 180 puntos en la escala Cambridge para aprobar con calificación C (nivel C1). Con 193+ puntos obtienes calificación B, y con 200+ puntos obtienes calificación A, que certifica nivel C2. Si obtienes entre 160-179 puntos, recibes certificado de nivel B2.'
  },
  {
    question: '¿El certificado C1 Advanced caduca?',
    answer: 'No, el certificado Cambridge C1 Advanced tiene validez permanente y no caduca nunca. A diferencia de TOEFL o IELTS que expiran tras 2 años, puedes usar tu C1 Advanced durante toda tu vida sin necesidad de renovación. Algunas instituciones pueden preferir certificados recientes, pero el documento oficial mantiene su validez.'
  },
  {
    question: '¿Qué diferencia hay entre C1 Advanced y C2 Proficiency?',
    answer: 'El C1 Advanced certifica nivel avanzado (C1) mientras que el C2 Proficiency certifica maestría completa (C2). El C2 es más exigente en vocabulario, estructuras gramaticales complejas y comprensión de matices sutiles. Para la mayoría de propósitos académicos y profesionales, el C1 Advanced es suficiente y ampliamente reconocido.'
  },
  {
    question: '¿Cuánto tiempo de preparación necesito para el C1 Advanced?',
    answer: 'Depende de tu nivel actual. Candidatos con B2 consolidado necesitan típicamente 200-300 horas de preparación (6-9 meses con 8-10 horas semanales). Candidatos con B2 fuerte pueden prepararse en 4-6 meses. Se recomienda realizar simulacros completos para familiarizarse con el formato y gestión del tiempo.'
  },
];
...
export default function ExamenCambridgeC1Page() {
  ...
  const articleSchema = generateArticleSchema({
    ...
    url: `${businessInfo.url}/examenes-cambridge/c1-advanced-guia`,
  ...
  return (
    <>
      <SEOHead
        ...
        canonical="/examenes-cambridge/c1-advanced-guia"
        ogType="article"
      />
      <Navbar />
      ...
      <article>
        {/* Hero Section */}
        <header className="pt-24 pb-16 md:pt-32 md:pb-20 bg-gradient-to-br from-indigo-600 to-indigo-900">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-16">
              ...
              <p className="text-zinc-600 leading-relaxed">
                Si buscas preparación estructurada con metodología probada, <Link to="/academia-ingles-barrio-del-pilar" className="text-indigo-600 hover:underline font-medium">nuestra academia en Barrio del Pilar</Link>, <Link to="/academia-ingles-la-vaguada" className="text-indigo-600 hover:underline font-medium">junto a La Vaguada</Link>, ofrece <Link to="/ingles-la-vaguada/adultos" className="text-indigo-600 hover:underline font-medium">cursos de inglés para adultos</Link> y <Link to="/ingles-la-vaguada/particulares" className="text-indigo-600 hover:underline font-medium">clases particulares</Link> específicos de preparación C1 Advanced con profesores certificados y tasas de éxito excepcionales. Reserva tu clase gratuita para comenzar tu camino hacia la certificación avanzada.
              </p>
            </section>
