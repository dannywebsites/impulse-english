...
const articleSchema = generateArticleSchema({
  ...
  url: `${businessInfo.url}/examenes-cambridge/guia-completa`,
...
export default function ExamenesCambridgeGuiaPage() {
  ...
  return (
    <>
      <SEOHead
        title="Exámenes Cambridge 2026: Guía Completa de Niveles y Preparación | Impulse English Academy"
        ...
        canonical="/examenes-cambridge/guia-completa"
        ogType="article"
      />
      <Navbar />
