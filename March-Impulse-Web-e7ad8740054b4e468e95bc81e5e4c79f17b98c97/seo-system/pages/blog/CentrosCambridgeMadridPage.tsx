...
export default function CentrosCambridgeMadridPage() {
  ...
  const faqs = [
    ...
    {
      question: "¿Dónde puedo hacer el examen Cambridge en Madrid?",
      answer: "En Madrid existen más de 16 centros autorizados Cambridge, incluyendo centros Platino con hasta 48 convocatorias anuales y formatos digital y papel. Las sedes se encuentran en el centro de Madrid, Alcalá de Henares, Getafe y Pozuelo de Alarcón. El 68% de candidatos madrileños optan por formato digital con resultados en 2-3 semanas."
    },
    {
      question: "¿Cuántas veces al año hay exámenes Cambridge?",
      answer: "Los centros Cambridge organizan entre 12 y 48 convocatorias anuales según su categoría (regular o Platino). Los centros Platino ofrecen exámenes prácticamente semanales en formato digital para niveles B2 First y C1 Advanced. El formato papel tiene convocatorias mensuales o bimensuales. Las fechas más demandadas son junio y diciembre."
    }
  ];
    ...
    <>
      ...
      <div className="min-h-screen flex flex-col bg-white">
        ...
        <main className="flex-grow">
          {/* Hero Section */}
          <section className="relative bg-gradient-to-br from-red-600 via-red-700 to-rose-700 py-16 md:py-24">
          ...
          <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <section className="mt-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Link to="/examenes-cambridge/guia-completa" className="group bg-gray-50 rounded-xl p-6 hover:bg-red-50 transition-colors">
                ...
                <Link to="/examenes-cambridge/precio-c1" className="group bg-gray-50 rounded-xl p-6 hover:bg-red-50 transition-colors">
                  <h3 className="font-semibold text-gray-900 group-hover:text-red-600 transition-colors mb-2">
