...
export default function AprendeInglesGuiaPage() {
  ...
  return (
    <>
      ...
      <article>
        {/* Hero Section */}
        <header className="pt-24 pb-16 md:pt-32 md:pb-20 bg-gradient-to-br from-purple-600 to-indigo-800">
            ...
            <section id="mejores-cursos" className="scroll-mt-24 mb-16">
              ...
              <div className="bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl p-6 text-white">
                ...
                <p className="text-white/90">
                  Para certificación oficial Cambridge, combina nuestros <Link to="/ingles-la-vaguada/adultos" className="text-white hover:underline font-bold">cursos de inglés para adultos</Link> en nuestra <Link to="/academia-ingles-la-vaguada" className="text-white hover:underline font-bold">academia junto a La Vaguada</Link> (preparación estructurada)
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <ul className="text-zinc-600 space-y-1">
                      ...
                      <li>• <Link to="/examenes-cambridge/linguaskill" className="text-purple-600 hover:underline font-medium">Linguaskill</Link> (resultados 48h)</li>
