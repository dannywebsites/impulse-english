...
export default function CursosInglesAdultosMadridPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = 'Cursos de Inglés para Adultos en Madrid 2025 | Guía Completa | Impulse English Academy La Vaguada – Barrio del Pilar';
  }, []);
  ...
  const faqs = [
    {
      ...
      answer: "Las empresas exigen principalmente B2 para comunicación cotidiana y C1 para roles especializados, directivos o internacionales. Sectores como tecnología, finanzas, consultoría y turismo valoran especialmente el Business English certificado con Linguaskill Business o Cambridge."
    },
    {
      question: "¿B2 es suficiente para trabajar?",
      answer: "El B2 es suficiente para la mayoría de entornos laborales, permitiendo comunicación fluida, participación en reuniones y redacción de correos profesionales. Es requisito para visas laborales como la Skilled Worker en Reino Unido y para muchas ofertas de empleo internacional."
    },
    {
      question: "¿Cuánto cuestan los cursos de inglés para adultos en Madrid?",
    ...
    {
      question: "¿Cuántas horas semanales necesito estudiar para progresar?",
      answer: "Para progresar un nivel completo (por ejemplo, de B1 a B2) se necesitan aproximadamente 200 horas de estudio guiado. Con 3-4 horas semanales de clase más práctica personal, podrías conseguirlo en 9-12 meses. Cursos intensivos de 15-20 horas semanales permiten avanzar un nivel en 2-3 meses."
    },
    {
      question: "¿Puedo obtener certificación oficial estudiando en academias privadas?",
      answer: "Las academias privadas preparan específicamente para exámenes oficiales como Cambridge (B1 Preliminary, B2 First, C1 Advanced) y Linguaskill. Algunas academias son centros examinadores autorizados donde puedes realizar el examen tras la preparación. Verifica tasas de aprobación publicadas antes de elegir."
    },
    {
      question: "¿Inglés de negocios o general?",
      answer: "El inglés de negocios (Business English) es clave para avanzar profesionalmente, enfocándose en comunicación específica de marketing, finanzas, negociaciones y presentaciones. Desarrolla habilidades para liderar, persuadir y gestionar equipos internacionales con vocabulario especializado."
    },
    {
      question: "¿Cómo poner nivel de inglés en CV?",
      answer: "Incluir el nivel usando escalas oficiales como el MCER (A1-C2) en la sección \"Idiomas\". Añadir certificaciones (Cambridge, Linguaskill, IELTS) aporta credibilidad y diferenciación. Sin certificado, describir habilidades específicas con honestidad: \"Conversación fluida\" o \"Lectura técnica\"."
    }
  ];
  ...
  return (
    <>
      <SEOHead
        title="Cursos de Inglés para Adultos en Madrid: Guía Completa 2025 - EOI, Academias y Particulares"
        description="Guía completa de cursos de inglés para adultos en Madrid: EOI, academias privadas, clases particulares. Compara precios, horarios, metodologías y certificaciones."
        keywords="cursos inglés adultos madrid, inglés para adultos madrid, clases inglés adultos, eoi madrid, academias inglés adultos"
        canonical="/academias-ingles-madrid/adultos"
        ogType="article"
      />
      <div className="min-h-screen flex flex-col bg-white">
        ...
        <main className="flex-grow">
          {/* Hero Section */}
          <section className="relative bg-gradient-to-br from-slate-700 via-slate-800 to-gray-900 py-12 md:py-20">
          ...
          <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <p className="text-lg text-gray-700 mb-8 leading-relaxed">
              Madrid ofrece cientos de opciones para estudiar inglés siendo adulto, desde las económicas Escuelas Oficiales de Idiomas hasta academias privadas especializadas y <Link to="/ingles-la-vaguada/particulares" className="text-slate-700 hover:underline font-medium">clases particulares</Link> personalizadas. Esta guía te ayuda a navegar entre todas las alternativas para encontrar el curso que mejor se adapte a tus necesidades profesionales, disponibilidad horaria y presupuesto. Ya seas un profesional que necesita inglés para su carrera o alguien que quiere retomar el idioma después de años, aquí encontrarás la información que necesitas. Si buscas academias en zonas específicas como <Link to="/academia-ingles-tetuan" className="text-slate-700 hover:underline font-medium">Tetuán</Link>, <Link to="/academia-ingles-plaza-castilla" className="text-slate-700 hover:underline font-medium">Plaza Castilla</Link> o <Link to="/academia-ingles-la-vaguada" className="text-slate-700 hover:underline font-medium">junto a La Vaguada</Link>, disponemos de sedes en el norte de Madrid.
            </p>
            ...
            <section id="opciones" className="mb-12">
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white border border-gray-200 rounded-xl p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Las academias privadas ofrecen mayor flexibilidad y atención personalizada. En Madrid hay cientos de opciones, desde grandes franquicias hasta academias locales especializadas. Suelen ofrecer grupos reducidos de 6-12 alumnos, horarios flexibles incluyendo tardes-noches y fines de semana, y metodologías comunicativas modernas. Muchas son centros preparadores oficiales para <Link to="/examenes-cambridge" className="text-slate-600 hover:underline">exámenes Cambridge</Link> y <Link to="/examenes-cambridge/linguaskill" className="text-slate-600 hover:underline">Linguaskill</Link>.
                  </p>
                  <div className="flex flex-wrap gap-2">
                ...
                <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl p-6">
                  ...
                  <p className="text-gray-700 mb-4">
                    Centro oficial de preparación Cambridge en el norte de Madrid. Ubicados <Link to="/academia-ingles-la-vaguada" className="text-blue-700 hover:underline">junto a La Vaguada</Link> en <Link to="/academia-ingles-barrio-del-pilar" className="text-blue-700 hover:underline">Barrio del Pilar</Link>. Cursos presenciales y online con total flexibilidad. Profesores cualificados y certificados con metodología comunicativa. 100% de aprobados en exámenes Cambridge 2024/25. Grupos reducidos de máximo 7-10 alumnos.
                  </p>
                  ...
                  <Link to="/ingles-la-vaguada/adultos" className="inline-flex items-center gap-2 text-blue-700 font-semibold hover:text-blue-800">
            ...
            <section className="mb-12">
              ...
              <div className="bg-gradient-to-r from-slate-50 to-gray-100 rounded-2xl p-8">
                <p className="text-gray-700 mb-4 leading-relaxed">
                  Madrid ofrece opciones de <Link to="/ingles-la-vaguada/adultos" className="text-slate-700 hover:underline font-medium">cursos de inglés para adultos</Link> para todos los perfiles: desde las económicas EOI para quienes tienen horarios flexibles y presupuesto ajustado, hasta academias privadas especializadas para profesionales que necesitan flexibilidad y atención personalizada. Si tu objetivo es obtener una certificación oficial de inglés, asegúrate de elegir una academia con experiencia en preparación de <Link to="/examenes-cambridge" className="text-slate-700 hover:underline font-medium">exámenes Cambridge</Link>.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  Para adultos en el norte de Madrid (<Link to="/academia-ingles-barrio-del-pilar" className="text-slate-700 hover:underline font-medium">Barrio del Pilar</Link>, <Link to="/academia-ingles-penagrande" className="text-slate-700 hover:underline font-medium">Peñagrande</Link>, <Link to="/academia-ingles-la-ventilla" className="text-slate-700 hover:underline font-medium">La Ventilla</Link>), <strong>Impulse English Academy</strong> en <Link to="/academia-ingles-la-vaguada" className="text-slate-700 hover:underline font-medium">La Vaguada</Link> ofrece grupos reducidos de 7-10 alumnos, horarios adaptados a profesionales, modalidad presencial y online con total flexibilidad, y profesores cualificados y certificados. Centro oficial de preparación Cambridge con 100% de aprobados en 2024/25.
                </p>
              </div>
            </section>
            ...
            <section className="mt-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <Link to="/academias-ingles-madrid" className="group bg-gray-50 rounded-xl p-6 hover:bg-slate-50 transition-colors">
                ...
                <Link to="/examenes-cambridge/guia-completa" className="group bg-gray-50 rounded-xl p-6 hover:bg-slate-50 transition-colors">
                  <h3 className="font-semibold text-gray-900 group-hover:text-slate-700 transition-colors mb-2">
                    Guía de Exámenes Cambridge
                  </h3>
                  <p className="text-gray-600 text-sm">Todo sobre las certificaciones oficiales de inglés.</p>
                </Link>
                <Link to="/linguaskill" className="group bg-gray-50 rounded-xl p-6 hover:bg-slate-50 transition-colors">
                  <h3 className="font-semibold text-gray-900 group-hover:text-slate-700 transition-colors mb-2">
                    Guía de Linguaskill
                  </h3>
                  <p className="text-gray-600 text-sm">Certificación rápida y flexible con resultados en 48 horas.</p>
                </Link>
                <Link to="/examenes-cambridge/b2-first" className="group bg-gray-50 rounded-xl p-6 hover:bg-slate-50 transition-colors">
                  <h3 className="font-semibold text-gray-900 group-hover:text-slate-700 transition-colors mb-2">
