...
export default function EscalaCambridgePage() {
  ...
  const articleSchema = generateArticleSchema({
    ...
    url: `${businessInfo.url}/examenes-cambridge/escala-cambridge`,
    datePublished: "2025-01-05"
  });

  const faqs = [
    {
      question: "¿Qué es el nivel B1/B2/C1?",
      answer: "El nivel B1 (intermedio del MCER) permite comprender textos claros sobre temas conocidos, manejar situaciones de viaje y producir textos sencillos. El B2 (usuario independiente) capacita para entender textos complejos, comunicarse con fluidez y escribir argumentos detallados. El C1 (usuario competente) habilita para comprender textos exigentes con significados implícitos, expresarse espontáneamente y usar el idioma flexiblemente en contextos académicos y profesionales."
    },
    {
      question: "¿B1 vs B2 qué nivel necesito?",
      answer: "El nivel B1 es intermedio básico, permite comunicarse en situaciones cotidianas y escritas sencillas, suficiente para viajes y requisitos universitarios. El B2 es intermedio alto, ideal para conversaciones fluidas, comprensión de textos complejos y ámbitos laborales exigentes, ofreciendo mayor precisión y seguridad comunicativa."
    },
    {
    ...
    {
      question: "¿Cómo se relaciona la escala Cambridge con el CEFR?",
      answer: "La escala Cambridge está directamente alineada con el Marco Común Europeo de Referencia: 100-119 = A2, 120-139 = B1, 140-159 = B2, 160-179 = B2 alto/C1, 180-199 = C1, 200-230 = C2. Esta correspondencia permite traducir tu puntuación a niveles reconocidos internacionalmente."
    },
    {
      question: "¿Puedo obtener un nivel superior al del examen que presento?",
      answer: "Sí, si obtienes una puntuación excepcional (Grade A), Cambridge certifica el nivel superior. Por ejemplo, con 180+ puntos en B2 First obtienes certificado con nivel C1. Esto solo funciona 'hacia arriba'; no puedes presentar un examen de nivel superior y certificar el inferior si no apruebas."
    }
  ];
  ...
  return (
    <>
      <SEOHead
        ...
        canonical="/examenes-cambridge/escala"
        ogType="article"
      />
      <Navbar />

      {/* Hero Section */}
      <section className="pt-24 pb-12 md:pt-32 md:pb-16 bg-gradient-to-br from-indigo-600 to-purple-700">
