...
export default function CentrosLinguaskillPage() {
  ...
  const articleSchema = generateArticleSchema({
    ...
    url: `${businessInfo.url}/linguaskill/centros`,
  ...
  return (
    <>
      ...
      <article>
        {/* Hero Section */}
        <header className="pt-24 pb-16 md:pt-32 md:pb-20 bg-gradient-to-br from-teal-600 to-teal-800">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section id="que-es" className="mb-16 scroll-mt-24">
              ...
              <p className="text-zinc-600 leading-relaxed mb-6">
                <a href="https://www.cambridgeenglish.org/es/exams-and-tests/linguaskill/" target="_blank" rel="noopener noreferrer" className="text-teal-600 hover:underline">Linguaskill</a> es el examen de inglés computerizado de Cambridge Assessment English que evalúa niveles del B1 al C2 del Marco Común Europeo de Referencia mediante tecnología adaptativa basada en inteligencia artificial. El sistema ajusta la dificultad de las preguntas en tiempo real según las respuestas del candidato, lo que permite obtener una medición precisa del nivel real en aproximadamente 90 minutos totales.
              </p>
            ...
            <section className="mb-16">
              ...
              <p className="text-zinc-600 leading-relaxed">
                Si buscas preparación intensiva antes del examen, nuestra <Link to="/academia-ingles-barrio-del-pilar" className="text-teal-600 hover:underline font-medium">academia en Barrio del Pilar</Link>, junto a <Link to="/academia-ingles-la-vaguada" className="text-teal-600 hover:underline font-medium">La Vaguada</Link>, ofrece <Link to="/ingles-la-vaguada/adultos" className="text-teal-600 hover:underline font-medium">cursos específicos para adultos</Link> que combinan metodología probada con simulacros del formato oficial <Link to="/examenes-cambridge/linguaskill" className="text-teal-600 hover:underline font-medium">Linguaskill</Link>. También preparamos otros <Link to="/examenes-cambridge" className="text-teal-600 hover:underline font-medium">exámenes Cambridge</Link> como <Link to="/examenes-cambridge/b2-first" className="text-teal-600 hover:underline font-medium">B2 First</Link>.
              </p>
            </section>
