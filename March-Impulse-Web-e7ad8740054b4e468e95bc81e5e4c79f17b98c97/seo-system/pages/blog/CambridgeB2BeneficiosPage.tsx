...
const faqs = [
  ...
  },
  {
    ...
    answer: 'El B2 First es aceptado por gobiernos de Reino Unido, Australia, Nueva Zelanda y Canadá para algunos tipos de visados de trabajo y estudio. Reino Unido lo reconoce para visados Tier 4 (estudiantes) y Tier 5 (trabajadores temporales). Sin embargo, visados de residencia permanente suelen requerir certificaciones específicas como IELTS General o pruebas de nacionalidad.'
  },
  {
    question: '¿Tener el B2 First garantiza conseguir trabajo en el extranjero?',
    answer: 'El B2 First demuestra competencia lingüística suficiente para funcionar profesionalmente en inglés, pero no garantiza por sí solo ofertas laborales. Empresas valoran la certificación como evidencia verificable de capacidad comunicativa, pero evalúan también experiencia profesional, habilidades técnicas y ajuste cultural. El certificado diferencia tu candidatura en procesos competitivos.'
  },
];
...
export default function CambridgeB2BeneficiosPage() {
  ...
  const articleSchema = generateArticleSchema({
    ...
    url: `${businessInfo.url}/examenes-cambridge/b2-beneficios`,
  ...
  return (
    <>
      <SEOHead
        ...
        canonical="/examenes-cambridge/b2-beneficios"
        ogType="article"
      />
      <Navbar />
      ...
      <article>
        {/* Hero Section */}
        <header className="pt-24 pb-16 md:pt-32 md:pb-20 bg-gradient-to-br from-red-600 to-red-800">
        ...
        <section className="py-16 bg-zinc-50">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Link
                to="/examenes-cambridge/c1-advanced-guia"
                className="bg-white rounded-xl p-6 shadow-sm hover:shadow-md transition-shadow"
              >
