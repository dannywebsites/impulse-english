...
export default function CertificadoLinguaskillPage() {
  useEffect(() => {
    window.scrollTo(0, 0);
    document.title = 'Certificado Linguaskill y su Validez | Guía Completa 2025 | Impulse English Academy La Vaguada – Barrio del Pilar';
  }, []);
  ...
  const articleSchema = generateArticleSchema({
    ...
    url: `${businessInfo.url}/linguaskill/certificado-linguaskill`,
  ...
  return (
    <>
      <SEOHead
        ...
        canonical="/linguaskill/certificado-validez"
        ogType="article"
      />
      <div className="min-h-screen flex flex-col bg-white">
        ...
        <main className="flex-grow">
          {/* Hero Section */}
          <section className="relative bg-gradient-to-br from-violet-600 via-violet-700 to-purple-700 py-16 md:py-24">
          ...
          <article className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-12">
            ...
            <section className="mb-12">
              ...
              <div className="bg-gradient-to-r from-violet-50 to-purple-50 rounded-2xl p-8">
                ...
                <p className="text-gray-700 leading-relaxed">
                  Si buscas preparación especializada para alcanzar la certificación que necesitas, nuestra <Link to="/academia-ingles-barrio-del-pilar" className="text-violet-600 hover:underline font-medium">academia en Barrio del Pilar</Link>, junto a <Link to="/academia-ingles-la-vaguada" className="text-violet-600 hover:underline font-medium">La Vaguada</Link>, ofrece <Link to="/ingles-la-vaguada/adultos" className="text-violet-600 hover:underline font-medium">cursos específicos de inglés para adultos</Link> con metodología probada y tasas de éxito del 100% en <Link to="/examenes-cambridge" className="text-violet-600 hover:underline font-medium">exámenes Cambridge</Link>.
                </p>
              </div>
            </section>
            ...
            <section className="mt-16">
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <Link to="/linguaskill/registro" className="group bg-gray-50 rounded-xl p-6 hover:bg-violet-50 transition-colors">
                  <h3 className="font-semibold text-gray-900 group-hover:text-violet-600 transition-colors mb-2">
