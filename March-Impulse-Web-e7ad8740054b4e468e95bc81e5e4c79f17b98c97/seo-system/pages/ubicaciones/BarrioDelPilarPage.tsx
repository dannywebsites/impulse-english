...
const benefits = [
  ...
  { title: "145+ Familias de Barrio del Pilar Nos Eligen", desc: "Más de 145 reseñas de 5 estrellas en Google." },
...
const localFaqs = [
  ...
  },
  {
    ...
    answer: "Tenemos horarios de mañana y tarde: lunes y miércoles de 10:00 a 21:30, martes y jueves de 15:30 a 21:30, y viernes de 15:30 a 19:30. Adaptamos los horarios a familias y profesionales del barrio."
  },
  {
...
export default function BarrioDelPilarPage() {
  ...
  return (
    <>
      <SEOHead
        title="Academia de Inglés en Barrio del Pilar"
        description="Academia de inglés en Barrio del Pilar, junto a La Vaguada. Centro preparador Cambridge oficial. Cursos para niños y adultos. 100% aprobados."
        keywords="academia inglés barrio del pilar, clases inglés la vaguada, cambridge barrio pilar, cursos inglés madrid norte"
        canonical="/academia-ingles-barrio-del-pilar"
      />
      <SchemaMarkup schema={generateLocationPageSchema({
        locationName: "Barrio del Pilar",
        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="max-w-4xl">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="https://wa.me/34604910611?text=Hola,%20vivo%20en%20Barrio%20del%20Pilar%20y%20me%20gustaría%20información%20sobre%20los%20cursos"
                target="_blank"
      ...
      <section className="py-12 md:py-16 px-6 bg-white">
        <div className="container mx-auto max-w-4xl">
          <p className="text-lg text-zinc-700 leading-relaxed">
            Nuestra academia ofrece clases de inglés en Barrio del Pilar, una zona bien comunicada y cercana al centro comercial La Vaguada y la estación de Metro Barrio del Pilar (Línea 9). Trabajamos con niños, adolescentes y adultos que buscan aprender inglés sin largos desplazamientos, con grupos reducidos y atención personalizada. Somos centro oficial de preparación Cambridge con 100% de aprobados.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 md:py-20 px-6 bg-zinc-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="text-center mt-8">
            <Link to="/ingles-la-vaguada/adultos" className="text-accent-blue font-semibold hover:underline inline-flex items-center gap-1">
      ...
      <section className="py-16 px-6 bg-zinc-50">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-zinc-600 mb-8">
            Más de 145 familias de Barrio del Pilar confían en nosotros. Lee sus experiencias reales en Google.
          </p>
          <a
