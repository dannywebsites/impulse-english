...
const benefits = [
  ...
  { title: "Familias de Peñagrande Confían en Nosotros", desc: "145+ reseñas de 5 estrellas en Google." },
...
const courses = [
  ...
  { name: "Primaria (6-12 años)", method: "Cambridge Young Learners", price: "71€/mes", href: "/ingles-la-vaguada/primaria" },
  { name: "Secundaria (13-17 años)", method: "Cambridge B1/B2/C1 + EBAU", price: "Desde 75€/mes", href: "/ingles-la-vaguada/secundaria" },
  { name: "Adultos", method: "Principiantes hasta avanzados", price: "79€/mes", href: "/ingles-la-vaguada/adultos" },
  { name: "Clases Particulares", method: "Presencial u online", price: "Flexible", href: "/ingles-la-vaguada/particulares" }
];
...
export default function PenagrandePage() {
  ...
  return (
    <>
      <SEOHead
        title="Academia de Inglés en Peñagrande"
        description="Academia de inglés cerca de Peñagrande Madrid. Centro preparador Cambridge oficial con 100% aprobados. A 15 min de Metro Peñagrande. Grupos reducidos."
        keywords="academia inglés peñagrande, clases inglés peñagrande, cursos inglés peñagrande madrid, cambridge peñagrande, aprender inglés peñagrande"
        canonical="/academia-ingles-penagrande"
      />
      <SchemaMarkup schema={generateLocationPageSchema({
        locationName: "Peñagrande",
        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          <div className="max-w-4xl">
            ...
            <p className="text-white/70 mb-8">
              Av. de El Ferrol, 22, La Vaguada, zona Peñagrande, 28029 Madrid
            </p>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a
                href="https://wa.me/34604910611?text=Hola,%20vivo%20en%20Peñagrande%20y%20me%20gustaría%20información%20sobre%20los%20cursos"
                target="_blank"
      ...
      <section className="py-12 md:py-16 px-6 bg-white">
        <div className="container mx-auto max-w-4xl">
          <p className="text-lg text-zinc-700 leading-relaxed">
            Nuestra academia ofrece clases de inglés cerca de Peñagrande, una zona residencial bien comunicada con Metro Peñagrande (Línea 7) y Metro Barrio del Pilar (Línea 9). Trabajamos con niños, adolescentes y adultos que buscan aprender inglés sin largos desplazamientos, con grupos reducidos y atención personalizada. Somos centro oficial de preparación Cambridge con 100% de aprobados.
          </p>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-zinc-50">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-zinc-600 mb-8">
            Más de 145 familias de Peñagrande confían en nosotros. Lee sus experiencias reales en Google.
          </p>
          <a
      ...
      <section className="py-16 md:py-20 px-6 bg-zinc-50">
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/OUTSIDE+ACADEMY.jpg", alt: "Fachada exterior Impulse English Academy cerca Peñagrande La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Classroom+Facilities+Main+Classroom.JPG", alt: "Aula principal academia inglés cerca Peñagrande La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Technology-based+classroom+photo.JPG", alt: "Aula tecnológica academia inglés cerca Peñagrande La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Stairs.JPG", alt: "Interior academia dos plantas cerca Peñagrande La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Infantil+classes.JPG", alt: "Clases inglés infantil cerca Peñagrande La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Primary+classes+students+smiling.JPG", alt: "Estudiantes primaria felices cerca Peñagrande La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Daniel+helping+secondary+school+students.JPG", alt: "Profesor Daniel ayudando estudiantes cerca Peñagrande La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Secondary+classes+student+happy.JPG", alt: "Estudiante secundaria feliz cerca Peñagrande La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Adult+one-to-one+classes.JPG", alt: "Clases particulares adultos cerca Peñagrande La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/JP+WITH+STUDENTS.jpg", alt: "Estudiantes certificados Cambridge cerca Peñagrande La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/impulsephotos/NACHOS+photos.+/Photos+of+facilities.JPG", alt: "Instalaciones academia inglés cerca Peñagrande La Vaguada Madrid" },
              { url: "https://impulseenglish.s3.us-east-1.amazonaws.com/NEW/Cambridge+logo+-+Edited.png", alt: "Centro Preparador Cambridge cerca Peñagrande La Vaguada Madrid" }
            ].map((img, idx) => (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-zinc-500 mt-6 text-sm">
                Av. de El Ferrol, 22, La Vaguada, cerca de Peñagrande, 28029 Madrid
              </p>
            </div>
            <div>
              <LeadForm
