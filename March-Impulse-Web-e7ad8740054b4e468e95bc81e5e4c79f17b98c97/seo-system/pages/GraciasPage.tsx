...
const courses = [
  { name: "Infantil (2-5 años)", description: "Great Little People. Música, movimiento, diversión.", href: "/ingles-la-vaguada/infantil" },
  { name: "Primaria (6-12 años)", description: "A1-A2. Cambridge Young Learners.", href: "/ingles-la-vaguada/primaria" },
  { name: "Secundaria (13-17 años)", description: "EBAU, Cambridge B1/B2/C1. 100% aprobados.", href: "/ingles-la-vaguada/secundaria" },
  { name: "Adultos", description: "Expertos en principiantes absolutos. Cambridge, Linguaskill.", href: "/ingles-la-vaguada/adultos" },
  { name: "Clases Particulares", description: "Presencial u online. Horarios flexibles.", href: "/ingles-la-vaguada/particulares" },
...
export default function GraciasPage() {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative pt-24 pb-16 md:pt-32 md:pb-24 bg-gradient-to-br from-green-500 to-emerald-600 overflow-hidden">
        <div className="relative container mx-auto px-6 md:px-12 text-center">
          ...
          <div className="mt-8 inline-block bg-white/20 backdrop-blur-sm px-6 py-3 rounded-full">
            <span className="text-white font-bold">Respuesta garantizada: Menos de 24 horas</span>
          </div>
        </div>
      </section>
